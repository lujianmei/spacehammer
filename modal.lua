...
modal.states = {
  ...
  main = {
    ...
    init = function(self, fsm)
      ...
      self.hotkeyModal:bind("","e", nil, function() fsm:toIdle(); windows.activateApp("Emacs") end)
      self.hotkeyModal:bind("","h", nil, function() fsm:toIdle(); windows.hideApp("Emacs") end)
      self.hotkeyModal:bind("","i", nil, function() fsm:toIdle(); windows.activateApp("iTerm2") end)
      self.hotkeyModal:bind("","u", nil, function() fsm:toIdle(); windows.hideApp("iTerm2") end)
     self.hotkeyModal:bind("","w", nil, function() fsm:toWindows() end)
      ...
      -- self.hotkeyModal:bind("", "e", nil, function() fsm:toEmacs() end)
